    ...
    <div className="w-full h-full min-h-[220px] pt-4 pb-2 pr-4">
      <ResponsiveContainer width="100%" height={220}>
        <AreaChart data={data} margin={{ top: 20, right: 30, left: 10, bottom: 30 }}>
          ...
          <Area type="monotone" dataKey="notes" stroke="#FDE047" fillOpacity={1} fill="url(#colorNotes)" strokeWidth={2} />
          <Area type="monotone" dataKey="videos" stroke="#67E8F9" fillOpacity={1} fill="url(#colorVid)" strokeWidth={2} />
          <Area type="monotone" dataKey="tests" stroke="#A78BFA" fillOpacity={1} fill="url(#colorTest)" strokeWidth={2} />
        </AreaChart>
      </ResponsiveContainer>
    </div>
  );
