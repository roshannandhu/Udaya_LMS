...
export default function RemindersPage() {
  ...
  const ReminderCard = ({ r }) => (
    <div className={`flex items-start gap-3 px-4 py-3 glass-panel rounded-xl shadow-sm transition-colors ${r.done ? 'border-white/40 opacity-60 bg-white/20' : 'border-white/60 hover:bg-white/60'}`}>
        ...
        {loading ? (
          ...
          <>
            <div>
              ...
              {active.length === 0 ? (
                <div className="text-center py-10 glass-panel border-dashed border-white/60 rounded-xl">
