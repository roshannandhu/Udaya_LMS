...
export default function StudentBroadcastsPage() {
  ...
  return (
    <div className="flex-1 h-full min-h-0 overflow-hidden flex flex-col bg-[#efeae2]">
      ...
      <div
        ref={messagesRef}
        className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-4 pt-4 lg:pb-4 md:px-8 space-y-2 max-w-5xl mx-auto w-full"
        style={{ paddingBottom: 'calc(96px + max(2rem, env(safe-area-inset-bottom)))' }}
      >
          {broadcasts.length === 0 ? (
