...
This step has two parts: **structural extraction** (deterministic, free) then **semantic extraction** (Codex, costs tokens).
...
What's inside:
  ...
  graphify-out/GRAPH_REPORT.md  - full audit report, also readable here in Codex
